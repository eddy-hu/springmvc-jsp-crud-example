...
<title>Ticket CRUD Data Table</title>
<link rel="stylesheet"
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success"
							data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add
								New Ticket</span></a> <a href="#deleteEmployeeModal" class="btn btn-danger"
...
<%-- 
						...
						<c:url var="updateLink" value="/customer/updateForm">
							<c:param name="customerId" value="${tempTicket.id}" />
						</c:url>
						...
						<tr>
							...
							<td>${tempTicket.openedDateTime}</td>
			...
			<div class="clearfix">
				<div class="hint-text">
					Showing <b>10</b> out of <b>150</b> entries
				</div>
				<ul class="pagination">
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form:form action="addTicket" method="get">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Active</label> <input type="number" id="active"
